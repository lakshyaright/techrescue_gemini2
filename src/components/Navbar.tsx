    ...
    <header className="sticky top-0 z-40 bg-slate-900/95 backdrop-blur border-b border-slate-800 text-slate-100 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-3.5 py-1.5 rounded-xl font-semibold text-sm shadow-md shadow-emerald-950 flex items-center gap-1.5 transition active:scale-95"
            >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700/80 border border-slate-700 px-2.5 py-1.5 rounded-xl text-left transition"
              >
                <img
        ...
        <div className="flex md:hidden items-center justify-around py-2 border-t border-slate-800 text-xs">
          <button
            onClick={() => setActivePortal("landing")}
            className={`px-2 py-1 rounded ${activePortal === "landing" ? "text-emerald-400 font-semibold" : "text-slate-400"}`}
          >
            Showcase
          </button>
          <button
            onClick={() => setActivePortal("client")}
            className={`px-2 py-1 rounded ${activePortal === "client" ? "text-teal-400 font-semibold" : "text-slate-400"}`}
          >
            Client Hub
          </button>
          <button
            onClick={() => setActivePortal("expert")}
            className={`px-2 py-1 rounded ${activePortal === "expert" ? "text-amber-400 font-semibold" : "text-slate-400"}`}
          >
            Engineer Console
          </button>
          <button
            onClick={() => setActivePortal("ops")}
            className={`px-2 py-1 rounded ${activePortal === "ops" ? "text-indigo-400 font-semibold" : "text-slate-400"}`}
          >
            HA Ops
          </button>
        </div>
